  ...
  const teamMembers = [
    {
      ...
      description:
        "Cole Wu, Automation engineer, Led a 7M dollars factory automation project.",
    },
    {
      name: "Melvin Liu",
      title: "Key Hires",
      image: "/images/c12t.png", // Replace with actual path
      description:
        "Melvin Liu, Mechanical engineer, 6 years of experience in mechanical design",
    },
    {
      name: "Larry Huang",
      title: "Key Hires",
      image: "/images/c12t.png", // Replace with actual path
      description:
        "Larry Huang, Software engineer, 6 years of experience in software infrastructure.",
    },
  ];
  ...
  return (
    ...
    <div className="flex flex-col justify-center items-center gap-8 md:flex md:flex-row md:justify-center md:items-center md:gap-8 p-6 bg-white">
      {teamMembers.map((member, index) => (
        <div
          key={index}
          className="relative w-60 h-64 group rounded-lg overflow-hidden bg-[#f7f7f7] p-4"
        >
